...
export const Defcon:React.FC = () => {
  return (
    <motion.div className="flex lg:gap-8 sm:gap-6 gap-4 px-6 lg:px-8 justify-between items-center"
    initial={{
      opacity:0,
      x:200,
    }}
    ...
    >
      ...
      <div className="flex flex-col ">
        <img src="/assets/defcon.png" alt="" className="lg:w-[31rem] lg:h-[8rem]" />
